    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(max_length=2097152, upload_to='static/design_photos/')),
                ('desc', models.CharField(max_length=255)),
                ('status', models.CharField(choices=[('new', 'Новая'), ('in_progress', 'Принято в работу'), ('сompleted', 'Выполнено')], default='new', max_length=100)),
